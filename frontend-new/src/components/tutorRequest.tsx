...
import {sendEmail, findTutorEmails, getCsv} from "./tutorRequestFunctions.ts";

function TutorRequest() {
    const [docID, setDocID] = useState("");
    const [dataArray, setDataArray] = useState([]);
    useEffect(() => {
        getCsv("gs://milton-tutor.appspot.com/courses.csv").then(r => {
            setDataArray(r.data)
        })
    }, []);

    async function saveRequest() {
        const temp = await addDoc(collection(db, "requests"), {
        ...
        const templateParams: Record<string, unknown> = {
            ...
            class_name: class1,
            tutor_emails: await findTutorEmails(class1),
            free: free,
            person_link: 'http://tutormilton.com/pairing/?id=' + docID
        }
        sendEmail("template_0zjm2a1", templateParams)
    }
    ...
    const onSubmit1 = (e: FormEvent) => {
        ...
        if (window.confirm("Confirm Request?")) {
            ...
            console.log(class1)
            console.log(free)
            console.log('http://tutormilton.com/register/' + encodeURIComponent(class1) + '/' + encodeURIComponent(docID))
            saveRequest();
            alert("Request Sent!")
        } else {
            return
    ...
    const onSubmit2 = (e: FormEvent) => {
        ...
        if (window.confirm("Confirm Request?")) {
            ...
            const templateParams: Record<string, unknown> = {
                ...
                class_name: class2,
                to_email: email2,
                person_link: 'http://tutormilton.com/register/?course=' + encodeURIComponent(class2) + '&id=' + auth.currentUser.uid
            }
            sendEmail("template_jqyyi2j", templateParams);
            alert("Email Sent!")
                        ...
                        <form id="request-form" onSubmit={onSubmit1}>
                            <div className="dropdown">
                                <select className="dropbtn" onChange={(e) => setClass1(e.target.value)}>
                                    ...
                                    {/*<option value="Adv Latin: Roman Historians (1/2)">Adv Latin: Roman Historians*/}
                                    {/*    (1/2)*/}
                                    {/*</option>*/}
                                    {/*<option value="Adv Latin: Roman Philosophy (Sem 1)">Adv Latin: Roman Philosophy (Sem*/}
                                    {/*    1)*/}
                                    {/*</option>*/}
                                    {/*<option value="Adv Latin: Selected Readings (Sem 2)">Adv Latin: Selected Readings*/}
                                    {/*    (Sem 2)*/}
                                    {/*</option>*/}
                                    {/*<option value="Latin 1">Latin 1</option>*/}
                                    {/*<option value="Latin 2">Latin 2</option>*/}
                                    {/*<option value="Latin 3">Latin 3</option>*/}
                                    {/*<option value="Latin 4: Lit of the Golden Age">Latin 4: Lit of the Golden Age*/}
                                    {/*</option>*/}
                                    ...
                                    {/*<option value="Adv Comp Sci: Applications (1/2)">Adv Comp Sci: Applications (1/2)*/}
                                    {/*</option>*/}
                                    {/*<option value="Adv Comp Sci: Applications (Sem 2)">Adv Comp Sci: Applications (Sem*/}
                                    {/*    2)*/}
                                    {/*</option>*/}
                                    {/*<option value="Advanced Topics in Computer Science">Advanced Topics in Computer*/}
                                    {/*    Science*/}
                                    {/*</option>*/}
                                    {/*<option value="Advanced Topics in Computer Science (1/2)">Advanced Topics in*/}
                                    {/*    Computer Science (1/2)*/}
                                    {/*</option>*/}
                                    {/*<option value="Applied Engineering & Design (1/2)">Applied Engineering & Design*/}
                                    {/*    (1/2)*/}
                                    {/*</option>*/}
                                    ...
                                    {/*<option value="Major Issues in 20th Century China">Major Issues in 20th Century*/}
                                    {/*    China*/}
                                    {/*</option>*/}
                                    ...
                                    {/*<option value="French 4: Culture & Literature">French 4: Culture & Literature*/}
                                    {/*</option>*/}
                                    ...
                                    {/*<option value="French 5 (Honors): Exploration of Lit">French 5 (Honors): Exploration*/}
                                    {/*    of Lit*/}
                                    {/*</option>*/}
                                    ...
                                    {/*<option value="Adv Hist: Af-American Hist (Sem 1)">Adv Hist: Af-American Hist (Sem*/}
                                    {/*    1)*/}
                                    {/*</option>*/}
                                    {/*<option value="American Gov't & Politics (Sem 1)">American Gov't & Politics (Sem*/}
                                    {/*    1)*/}
                                    {/*</option>*/}
                                    {/*<option value="Adv Hist: Asian American Hist (Sem 2)">Adv Hist: Asian American Hist*/}
                                    {/*    (Sem 2)*/}
                                    {/*</option>*/}
                                    {/*<option value="Adv Hist: Aztecs-High Tech (Sem 2)">Adv Hist: Aztecs-High Tech (Sem*/}
                                    {/*    2)*/}
                                    {/*</option>*/}
                                    ...
                                    {/*<option value="Adv Hist: Civil Rights (Sem 2)">Adv Hist: Civil Rights (Sem 2)*/}
                                    {/*</option>*/}
                                    ...
                                    {/*<option value="Adv Hist: Global & Islam (Sem 2)">Adv Hist: Global & Islam (Sem 2)*/}
                                    {/*</option>*/}
                                    {/*<option value="Adv Hist: Historical Archeology (1/2)">Adv Hist: Historical*/}
                                    {/*    Archeology (1/2)*/}
                                    {/*</option>*/}
                                    {/*<option value="Activism Justice Dig World (1/2)">Activism Justice Dig World (1/2)*/}
                                    {/*</option>*/}
                                    ...
                                    {/*<option value="Adv Hist: Modern China (Sem 1)">Adv Hist: Modern China (Sem 1)*/}
                                    {/*</option>*/}
                                    ...
                                    {/*<option value="Adv Hist: Topics/Modern Wld (Sem 1)">Adv Hist: Topics/Modern Wld (Sem*/}
                                    {/*    1)*/}
                                    {/*</option>*/}
                                    {/*<option value="U.S. History">U.S. History</option>*/}
                                    {/*<option value="U.S. History: Class III">U.S. History: Class III</option>*/}
                                    {/*<option value="The U.S. in the Modern World 1">The U.S. in the Modern World 1*/}
                                    {/*</option>*/}
                                    {/*<option value="The U.S. in the Modern World 2">The U.S. in the Modern World 2*/}
                                    {/*</option>*/}
                                    {/*<option value="World History: Challenges & Changemakers">World History: Challenges &*/}
                                    {/*    Changemakers*/}
                                    {/*</option>*/}
                                    {/*<option value="World History: Challenges & Changemakers">World History: Challenges &*/}
                                    {/*    Changemakers*/}
                                    ...
                                    {/*<option value="Advanced Functions w/Comp Science (Honors)">Advanced Functions w/Comp*/}
                                    {/*    Science (Honors)*/}
                                    {/*</option>*/}
                                    {/*<option value="Advanced Functions">Advanced Functions</option>*/}
                                    {/*<option value="Mathematics & Art (1/2)">Mathematics & Art (1/2)</option>*/}
                                    {/*<option value="Adv. Statistical Methods (Honors)">Adv. Statistical Methods*/}
                                    {/*    (Honors)*/}
                                    {/*</option>*/}
                                    ...
                                    {/*<option value="Advanced Topics in Math (Sem 1)">Advanced Topics in Math (Sem 1)*/}
                                    {/*</option>*/}
                                    {/*<option value="Advanced Topics in Math (Sem 2)">Advanced Topics in Math (Sem 2)*/}
                                    {/*</option>*/}
                                    ...
                                    {/*<option value="Advanced Calculus & Stats (Honors)">Advanced Calculus & Stats*/}
                                    {/*    (Honors)*/}
                                    {/*</option>*/}
                                    ...
                                    {/*<option value="Advanced Environmental Science">Advanced Environmental Science*/}
                                    {/*</option>*/}
                                    ...
                                    {/*<option value="Observational Astronomy (Sem 1)">Observational Astronomy (Sem 1)*/}
                                    {/*</option>*/}
                                    {/*<option value="Biology">Biology</option>*/}
                                    {/*<option value="Chemistry">Chemistry</option>*/}
                                    {/*<option value="Engineering The Future (1/2)">Engineering The Future (1/2)</option>*/}
                                    {/*<option value="Issues in Enviro Science (Sem 1)">Issues in Enviro Science (Sem 1)*/}
                                    {/*</option>*/}
                                    {/*<option value="Issues in Enviro Science (Sem 2)">Issues in Enviro Science (Sem 2)*/}
                                    {/*</option>*/}
                                    ...
                                    {/*<option value="Science in the Modern Age (1/2)">Science in the Modern Age (1/2)*/}
                                    {/*</option>*/}
                                    ...
                                    {dataArray.map(row => <option key={row['First Choice']}
                                                                  value={row['First Choice']}>{row['Course']}</option>)}
                            ...
                            <div className="dropdown">
                                <p></p>
                                <input placeholder="Add Your Teacher's Email" className="txt-Box2" value={email1}
                                       onChange={(e) => setEmail1(e.target.value)}/>

                                <input placeholder="When can you meet?" className="txt-Box2" value={free}
                ...
                <div className="column">
                    <div className="profComp">
                        ...
                        <form id="subject-form" onSubmit={onSubmit2}>
                            ...
                            <p></p>
                            <input placeholder="Enter Teacher's Email For Approval" className="txt-Box2" value={email2}
