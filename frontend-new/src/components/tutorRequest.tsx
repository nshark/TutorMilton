...
import {sendEmail, findTutorEmails, getCsv, validateFormData, requestForm} from "./tutorRequestFunctions.ts";
...
function TutorRequest() {
  ...
  const onSubmit1 = (e: FormEvent) => {
    e.preventDefault();
    const formData:requestForm = {email:email1, subject:class1, free:free};
    try{
    ...
    if (window.confirm("Confirm Request?")) {
      ...
      console.log(free);
      console.log(
        "http://tutormilton.com/register/" +
          encodeURIComponent(class1) +
          "/" +
  ...
  const onSubmit2 = (e: FormEvent) => {
    ...
    if (window.confirm("Confirm Request?")) {
      ...
      console.log(
        "http://tutormilton.com/pairing/" +
          encodeURIComponent(class2) +
          "/" +
      ...
      const templateParams: Record<string, unknown> = {
        ...
        to_email: email2,
        person_link:
          "http://tutormilton.com/register/?course=" +
          encodeURIComponent(class2) +
          "&id=" +
            ...
            <form id="request-form" onSubmit={onSubmit1}>
              <div className="dropdown">
                ...
                >
                  ...
                  {dataArray.map((row) => (
                    <option
                      key={row["First Choice"]}
                      value={row["First Choice"]}
                    >
                      {row["Course"]}
                    </option>
                  ))}
              ...
              <div className="dropdown">
                <p></p>
                <input
                  placeholder="Add Your Teacher's Email"
                  className="txt-Box2"
                  value={email1}
        ...
        <div className="column">
          <div className="profComp">
            ...
            <form id="subject-form" onSubmit={onSubmit2}>
              ...
              <p></p>
              <input
                placeholder="Enter Teacher's Email For Approval"
                className="txt-Box2"
                value={email2}
